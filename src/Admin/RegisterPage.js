                ...
                <section tw="text-gray-600 relative">
                    <div tw="container py-12 mx-auto">
                        <div tw="flex flex-col text-center w-full mb-12">
                            <h1 tw="sm:text-4xl text-2xl font-black mb-4 text-primary-500">Admin Registration</h1>
                            <p tw="lg:w-2/3 mx-auto leading-relaxed text-base">TrackMyLost Admin registration portal</p>
                            <p tw="leading-relaxed text-base text-center mt-2">Already an Admin ? <NavLink to="/admin/login"> Log in </NavLink></p>
                        </div>
