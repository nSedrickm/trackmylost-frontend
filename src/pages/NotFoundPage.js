...
const Button = tw.a`flex mx-auto justify-center md:w-1/6 p-4 items-center text-white text-primary-500 border-0 border border-primary-500 rounded-4xl text-lg hocus:text-primary-500 hocus:no-underline`;

const NotFoundPage = () => {
    return (
        <AnimationRevealPage>
            <section tw="text-gray-600 relative">
                <div tw="container pt-24 md:pt-48 mx-auto">
