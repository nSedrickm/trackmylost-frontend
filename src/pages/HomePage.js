...
const Description = tw(SectionDescription)`mt-6 lg:text-xl text-gray-700 max-w-lg`;
const PrimaryButton = tw(PrimaryButtonBase)`mt-8 inline-block w-40 tracking-wide text-center py-3`;
