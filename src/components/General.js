...
export const SubmitButton = tw.button`flex mx-auto items-center text-white bg-primary-500 border-0 py-3 px-8 focus:outline-none hover:bg-primary-700 rounded-4xl text-lg`;
